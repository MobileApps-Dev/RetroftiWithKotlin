...
class CountryAdapter(context: Context, dataList: List<CountryModel>) : RecyclerView.Adapter<CountryAdapter.ViewHolder>() {
    var context = context
    ...
    override fun onBindViewHolder(holder: ViewHolder?, position: Int) {
        ...
        holder?.countryName?.text = model.stateName // Set Data to TextView
    }
